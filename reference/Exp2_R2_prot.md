...
inst/extdata/Exp2_R2_prot.txt), or as a \`QFeatures\` structure
(Exp2_R2_prot.ft). In the latter case, the quantitative data are those
of the raw intensities.

## Format

An object of class \`QFeatures\` related to proteins quantification. It
contains 6 samples divided into two conditions (25 fmol and 50 fmol) and
948 proteins.
