...
inst/extdata/Exp2_R100_prot.txt), or as a \`QFeatures\` structure
(Exp2_R100_prot.ft). In the latter case, the quantitative data are those
...
#> 
#>  [1] Convert: SummarizedExperiment with 923 rows and 6 columns 
```
